...
//recipes.remove(<advgenerators:MJOutput>);	//REMOVE
...
//recipes.remove(<advgenerators:Turbine>);	//REPLACE
recipes.remove(<advgenerators:FuelTank>);
//recipes.remove(<advgenerators:PowerCapacitor>);	//REPLACE
recipes.remove(<advgenerators:TurbineController>);
//recipes.remove(<advgenerators:TurbineRotor>);	//REPLACE
//recipes.remove(<advgenerators:TurbineBlade>);	//REPLACE
...
//MJOutput
//recipes.addShaped(<advgenerators:MJOutput>,	//REMOVE
...
//RFOutput
//recipes.addShaped(<advgenerators:RFOutput>,	//REPLACE
//[[<ore:plateAluminium>, <advgenerators:PowerIO>, <ore:plateAluminium>],
//[<advgenerators:IronFrame>, <ThermalExpansion:material:1>, <advgenerators:IronFrame>],
//[<ore:plateAluminium>, <advgenerators:IronWiring>, <ore:plateAluminium>]]); 

//Turbine
//recipes.addShaped(<advgenerators:Turbine>,	//REPLACE
...
//PowerCapacitor
//recipes.addShaped(<advgenerators:PowerCapacitor>,	//REPLACE
...
//TurbineRotor
//recipes.addShaped(<advgenerators:TurbineRotor>,	//REPLACE
...
//PowerIO
//recipes.addShaped(<advgenerators:PowerIO>,	//REPLACE
