...
CuttingSaw.addRecipe(<OpenComputers:item:30> * 4, null, <minecraft:stained_hardened_clay:13>, <liquid:lubricant> * 1, 200, 8);
CuttingSaw.addRecipe(<OpenComputers:item:30> * 4, null, <minecraft:stained_hardened_clay:13>, <liquid:ic2distilledwater> * 3, 400, 8);
CuttingSaw.addRecipe(<OpenComputers:item:30> * 4, null, <minecraft:stained_hardened_clay:13>, <liquid:water> * 5, 400, 8);