...
val SlabCTable = <minecraft:crafting_table>;	//FIX VANILLA ITEMS
val Pattern = <appliedenergistics2:item.ItemMultiMaterial:52>;
val ClearPane = <minecraft:glass_pane>;	//FIX VANILLA ITEMS
val ClearGlass = <minecraft:glass>;	//FIX VANILLA ITEMS
