...
val SilkyJewel = <minecraft:lapis_block>;	//FIX VANILLA ITEMS
...
val CarminiteReactor = <minecraft:bookshelf>;	//FIX VANILLA ITEMS
//val EssenceBush = <TConstruct:ore.berries.two:9>;	//REMOVED?
