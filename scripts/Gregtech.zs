...
BlastFurnace.addRecipe([<Thaumcraft:ItemShard>], <liquid:oxygen> * 9000, [<gregtech:gt.metaitem.01:2540>], 320, 100, 1200);	//TEST FIX
BlastFurnace.addRecipe([<Thaumcraft:ItemShard:1>], <liquid:oxygen> * 9000, [<gregtech:gt.metaitem.01:2541>], 320, 100, 1200);	//TEST FIX
BlastFurnace.addRecipe([<Thaumcraft:ItemShard:2>], <liquid:oxygen> * 9000, [<gregtech:gt.metaitem.01:2543>], 320, 100, 1200);	//TEST FIX
BlastFurnace.addRecipe([<Thaumcraft:ItemShard:3>], <liquid:oxygen> * 9000, [<gregtech:gt.metaitem.01:2542>], 320, 100, 1200);	//TEST FIX
BlastFurnace.addRecipe([<Thaumcraft:ItemShard:4>], <liquid:oxygen> * 9000, [<gregtech:gt.metaitem.01:2545>], 320, 100, 1200);	//TEST FIX
BlastFurnace.addRecipe([<Thaumcraft:ItemShard:5>], <liquid:oxygen> * 9000, [<gregtech:gt.metaitem.01:2544>], 320, 100, 1200);	//TEST FIX
