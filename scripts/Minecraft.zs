...
val Lens = <gregtech:gt.metaitem.01:24500>;	//CHANGED TO GT LENS

val Bowstring = <minecraft:string>;	//VANILLA FIX
...
val ClearPane = <minecraft:glass_pane>;	//VANILLA FIX

val WovenCloth = <harvestcraft:wovencottonItem>;

//val Torchberries = <TwilightForest:item.torchberries>;	//REMOVE, TF NOT INSTALLED
...
val Detector = <Railcraft:detector:1>;	//FIXED?
...
// -
recipes.addShapedMirrored(Torch, [
[<gregtech:gt.metaitem.01:8538>, null],
[Stick, null]]);
//-
recipes.addShapedMirrored(Torch * 2, [
[<gregtech:gt.metaitem.01:8538>, String],
[Stick, null]]);
// -
recipes.addShapedMirrored(Torch * 2, [
[<gregtech:gt.metaitem.01:8538>, null],
...
[Stick, null]]);
// -
//REMOVE TORCHBERRY TORCH RECIPE
